...
import { TrackUserOrderComponent } from './track-user-order/track-user-order.component';
import { LocationInstructionComponent } from './location-instruction/location-instruction.component';
import { EmailverificationComponent } from './layout/authorization/email-verification/emailverification/emailverification.component';
...
const routes: Routes = [
  ...
  {
    path: 'track-order',
    component: TrackUserOrderComponent,
  },
  {
    path: 'location-instructions',
    component: LocationInstructionComponent
  },
  {
