...
export class ThemeService implements OnDestroy {
  ...
  addPoppinFont(): void {
    const head = this.document.getElementsByTagName('head')[0];
    const styleLink = this.document.createElement('link');
    styleLink.id = `app-poppins`;
    styleLink.rel = 'stylesheet';
    styleLink.type = 'text/css';
    styleLink.href = 'https://fonts.googleapis.com/css2?family=Poppins:wght@500&display=swap'//'https://fonts.googleapis.com/css2?family=Poppins&display=swap'
    head.appendChild(styleLink);
  }
    ...
    switch (app_type) {
      case 1:  //Food
        switch (this.settings.selected_template) {
          ...
          case 1:
            ...
            style_sheets.push('/assets/styles/food-template-one/responsive.css');
            break;
          case 2:
          ...
          case 5:
            style_sheets.push('/assets/styles/food-template-one/inner.css');
            style_sheets.push('/assets/styles/food-template-one/style.css');
            style_sheets.push('/assets/styles/food-template-five/stylesheet.css');
            style_sheets.push('/assets/styles/food-template-five/custom.css');
            break;
        }
        break;
      ...
      case 2:  //Ecommerce
        switch (this.settings.selected_template) {
          ...
          case 6:
            style_sheets.push('/assets/styles/ecom-template-six/css/animate.css');
            style_sheets.push('/assets/styles/ecom-template-six/css/ecommerce.css');
            style_sheets.push('/assets/styles/ecom-template-six/css/responsive.css');
            style_sheets.push('/assets/styles/ecom-template-six/css/prettyPhoto.css');
            style_sheets.push('/assets/styles/ecom-template-six/css/price-range.css');
            style_sheets.push('/assets/styles/ecom-template-six/css/bootstrap.min.css');
            break;
        }
        break;
      ...
      case 8:  //Home Service
        switch (this.settings.selected_template) {
          case 0:
            ...
            break;
          case 1:
            style_sheets.push('/assets/styles/home-service-template-one/home-service.css');
            style_sheets.push('/assets/styles/home-service-template-one/media.css');
            break;
          case 2:
            style_sheets.push('/assets/styles/home-service.css');
            style_sheets.push('/assets/styles/home-service-template-two/home-service-template-two.css');
            this.addPoppinFont();
            break;
          case 3:
            style_sheets.push('/assets/styles/home-service.css');
            style_sheets.push('/assets/styles/saned_template/css/saned.css');
            style_sheets.push('/assets/styles/saned_template/css/media.css');
            break;
        }
        break;

      default:
        if (this.settings.enable_knock_theme == 0) {
          style_sheets.push('/assets/styles/custom.css');
        } else {
          style_sheets.push('/assets/styles/custom-knock-theme/custom.css');
        }
    }

    if (this.settings.enable_knock_theme == 1) {
      style_sheets.push('/assets/styles/custom-knock-theme/media.css');
    }
    return style_sheets;
  }
  ...
  public setStyles(appColor?: any): void {
    ...
    if (this.settings.isCustomFlow) {
      ...
      if (!!flow_data && flow_data.type < 11) {
        let css_path = '/assets/styles/custom.css';
        if (this.settings.enable_knock_theme == 1) {
          css_path = '/assets/styles/custom-knock-theme/custom.css';
        }
        this.addStyleSheets([css_path], this.settings.type);
      }
    }
