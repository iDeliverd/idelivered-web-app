...
export class UtilityService {
  ...
  setUserLocation(location: any) {
    ...
    if (!location.isCurrent && this.handler.latitude == latitude && this.handler.longitude == longitude && location.three_words == undefined) {
      return;
    }
  ...
  encryptData(data) {
    this.siteName = !!(this.siteName.trim()) ? this.siteName : GlobalVariable.SITE_NAME;
    try {
