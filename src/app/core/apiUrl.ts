export const ApiUrl = {
  ...
  globalSupplier: '/global-supplier',
  addToCart: '/v1/add_to_cart',
  updateCartInfo: '/update_cart_info',
  generateOrder: '/v2/genrate_order',
  payAgentExtraCharge: '/pay_agent_extra_charge',
  makePayment: '/user/order/make_payment',
  ...
  getSupplierCategoryListOnly: '/supplier_category_list',
  ...
  getSupplierRatingDoc: '/admin/get_hygiene_info',
  ...
  getSuggetion: '/random_product_show',
  giftCard: {
    list: '/home/gift/list',
  ...
  address: {
    ...
    addAddressForSpiltAddress: '/v2/add_new_address',
    editAddressForSpiltAddress: '/v2/edit_address',
    addAddressV3: '/v3/add_new_address',
    editAddressV3: '/v3/edit_address',
  ...
  orders: {
    ...
    cancelOrderOnStatuswiseDeduction: '/v1/cancel_order',
    ...
    trackOrder: '/v2/order_details_track'
  },
  ...
  auth: {
    ...
    forgetPasswordMobileNo: '/forget_password_mobile_no',
    changePasswordMobileNo: '/v1/change_password',
    emailVerification: '/verify_otp_email',
    emailVerificationForVendor: '/agent/verify_otp_email'
  },
  ...
  getCustomPageData: '/user/pages',
  getFilteredSupplierList: '/supplier_list_by_service',
  getTopFilteredSupplierList: '/get_top_rated_supplier_list',

  getCategoryList: '/category_list?access_type=admin',

  getSelectedExtraProduct: '/User/select_extra_product',
  updateOrderWithExtraProduct: '/User/confirm_extra_product',

  mtntoken: '/mtn-token',
  mtnLink: '/mtn-link',
  ozowPay: '/ozowpay',
  getAgentRating: '/user/agent_rating_list',
  getSupplierPlaceholderData: '/user/get_all_offer_list_of_placeholders',

  getZitoPayPaymentUrl: '/paystack/zitopay',
  
  getTahseelPaymentUrl: '/v1/generateTahseelURL',

  setNotificationLanguage: '/notification_language'
}
