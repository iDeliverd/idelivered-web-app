          ...
          if (event instanceof HttpResponse) {
            switch (event.body.status) {
              case 401:
                ...
                this.message.alert('error', this.translate.instant('OOPS!'), `${this.translate.instant('Sorry, your account has been logged in other device! Please login again to continue.')}`);
                break;
              case 0:
