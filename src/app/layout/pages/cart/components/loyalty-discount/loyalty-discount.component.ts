...
export class LoyaltyDiscountComponent implements OnInit, OnDestroy {
  ...
  setLoyaltyPoints() {
    ...
    this.message.toast('success', `${this.translate.instant('Loyalty Points Discount')} ${this.loyalty_applied ? this.translate.instant('Applied') : this.translate.instant('Removed')} ${this.translate.instant('Successully')}`);
