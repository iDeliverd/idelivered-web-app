...
import { CartFileUploadComponent } from './components/cart-file-upload/cart-file-upload/cart-file-upload.component';
import { CartSuggetionComponent } from './components/cart-suggetion/cart-suggetion.component';
import { CartSuggetionListComponent } from './components/cart-suggetion-list/cart-suggetion-list.component';
...
@NgModule({
  declarations: [
    ...
    CartFileUploadComponent,
    CartSuggetionComponent,
    CartSuggetionListComponent,
  ],
  imports: [
    CartSharedModule,
    OnlinePaymentModule,
