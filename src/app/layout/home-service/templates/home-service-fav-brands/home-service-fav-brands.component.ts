...
@Component({
  selector: 'app-home-service-fav-brands',
  templateUrl: './home-service-fav-brands.component.html',
  styleUrls: ['./home-service-fav-brands.component.scss']
})
export class HomeServiceFavBrandsComponent implements OnInit {
