...
@Component({
  selector: 'app-home-service-suppliers',
  templateUrl: './home-service-suppliers.component.html',
  styleUrls: ['./home-service-suppliers.component.scss']
})
export class HomeServiceSuppliersComponent implements OnInit {
